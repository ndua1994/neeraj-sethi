...
if(isset($_POST['add_category']))
{
	...
	$query=mysqli_query($conn,"insert into tbl_category 
...
<input type="text" name="cat_name" value="" class="form-control" placeholder="Name">
</div>
...
<input type="text" name="cat_img_alt" value="" class="form-control" placeholder="Image Alt Tag">
</div>
...
<textarea name="cat_descp" class="form-control" placeholder="Description" aria-hidden="true" rows="10"></textarea>
</div>
...
<button type="submit" name="add_category" class="btn btn-primary mr-2">Add</button>
